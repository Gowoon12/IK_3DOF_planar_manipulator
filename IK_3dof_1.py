...
def generate_random_dataset(filename, N=100000):
    ...
    theta2 = np.random.uniform(0, 360, N)
    theta3 = np.random.uniform(0, 360, N)

    with open(filename, "w", newline="") as f:
        writer = csv.writer(f)
        writer.writerow(["theta1_deg", "theta2_deg", "theta3_deg", "x", "y", "theta_global_deg"])
...
generate_random_dataset("robot_ik_random.csv", 100000)
...
X_raw, Y_raw = load_dataset("robot_ik_random.csv")
